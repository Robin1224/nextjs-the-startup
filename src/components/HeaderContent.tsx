...
const HeaderContent = (props: Props) => {
  return (
    <>
      ...
      <p className="text-base font-thin text-white mt-header-text-top leading-8 max-w-md">
      ...
      <p className="text-base font-thin text-white mt-header-whiteline leading-8 max-w-md">
