  ...
  return (
    <header className="p-5 md:p-8 bg-purple overlow-hidden md:content-end md:w-full flex @container/header transition-all">
      <div className="flex flex-col items-start md:mx-auto @md/header:!mr-16 md:pb-28">
        ...
        <p className="text-base @md/header:text-lg font-light	 text-white mt-header-text-top leading-8 max-w-md @md/header:max-w-[36.875rem]">
        ...
        <p className={`text-base @md/header:text-lg font-light	 text-white mt-header-whiteline leading-8 max-w-md @md/header:max-w-[36.875rem] ${(show ? "block" : "hidden")}`}>
        ...
        <button onClick={buttonHandler} className="text-base @md/header:text-lg font-light text-white mt-header-whiteline underline underline-offset-4 decoration-1">
          {buttonText}
        </button>
      </div>
    </header>
